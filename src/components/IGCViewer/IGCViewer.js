        ...
        <Paper className={classes.paper} elevation={3}>
          ...
          >
            ...
            <Grid item xs={12} lg={2}>
              <Button className={classes.buttonGetData} onClick={getData} variant="contained" color="primary">
                Submit
              </Button>
            </Grid>
            ...
            <Grid item xs={12} lg={6}>
              <Paper className={classes.paper}>
                ...
                <Button className={classes.buttonVisualize} onClick={visualizePath} variant="contained" color="primary" disabled={!mapPoints}>
